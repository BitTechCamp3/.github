...
###  모인
```
여러 코인의 대한 차트 정보를 실시간 조회할 수 있고  커뮤니티(네이버 주식 참고), 각 코인 당 채팅방 기능 구현
코인에 대한 실시간 가격 / 차트 정보를 확인하고 차트에 드로잉툴을 이용해 이미지를 만들 수 있고
차트데이터를 저장하는 기능을 제공하고 채팅방에 공유하며 커뮤니케이션 할 수 있는 프로그램입니다.
```
# 배포 링크

[모인 바로가기]((https://bittechcamp3.github.io/frontend/))  
<table>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td align="center">Gateway, User Domain, Board Domain, Eureka, Infra</td>
        <td align="center">Chatting Domain, Coin Domain, Kafka</td>
    </tr>
    <tr>
        <td align="center">
        ...
        <td align="center">
            <a href="https://github.com/BitTechCamp3/teamThreeGateway">Gateway</a> 
            <a href="https://github.com/BitTechCamp3/threeBoard">Board</a>
            <a href="https://github.com/BitTechCamp3/threeUser">User</a>
            <a href="https://github.com/BitTechCamp3/threeEureka">Eureka</a>
        </td>
        <td align="center">
            <a href="https://github.com/BitTechCamp3/threeChatting">Chatting</a> 
